...
public class ProfesorDAO {
    ...
    public ProfesorDTO validarUsuario(String login, String pass) throws MyException {
        ...
        try {
            ...
            pstmt = cnn.prepareStatement("SELECT clave_profesor as id, nombre "
                    + " FROM profesores WHERE user = ? AND clave  = MD5(?);");
    ...
    public String eliminarPersona(int clave_profesor) {
        ...
        try {
            int resul = 0;
            pstmt = cnn.prepareStatement("DELETE FROM profesores WHERE clave_profesor=?");
    ...
    public StringBuilder validarUserName(String userName) throws MyException {
        ...
        try {
            ...
            pstmt = cnn.prepareStatement("SELECT clave_profesor as cod, nombre, user FROM profesores WHERE user=?");
